package com.paradisetechnologies.brigthwing.jwplayer;
...
/*    private void updateOutput(String output) {
    ...
    public void onAdImpression(AdImpressionEvent adImpressionEvent)
    {
        ...
        //   adImpressionEvent.getCreativeType() + "\", \"" + adImpressionEvent.getAdPosition()
        //   .name() + "\")");
    ...
    {
        Log.d(TAG, "onAdPause");
        //   updateOutput("onAdPause(\"" + adPauseEvent.getTag() + "\", \"" + adPauseEvent
        //   .getOldState() + "\")");
    }
    ...
    {
        Log.d(TAG, "onAdPlay");
        //    updateOutput("onAdPlay(\"" + adPlayEvent.getTag() + "\", \"" + adPlayEvent
        //    .getOldState() + "\")");
    }
